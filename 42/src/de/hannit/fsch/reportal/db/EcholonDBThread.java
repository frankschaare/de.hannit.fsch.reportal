...
public class EcholonDBThread implements Callable<HashMap<String, Vorgang>> 
{
private final static Logger log = Logger.getLogger(EcholonDBThread.class.getSimpleName());	
...
private HashMap<String, Vorgang> distinctCases = new HashMap<String, Vorgang>();	
	...
	Vorgang v = null;
		try 
		{
		ps = con.prepareStatement(PreparedStatements.SELECT_ALLEVORGAENGE_LETZTE_12_MONATE);
